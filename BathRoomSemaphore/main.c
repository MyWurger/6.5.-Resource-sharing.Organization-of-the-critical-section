...
void* male(void* arg)                      // аргументы, передаваемы в поток мужчины
{
    ...
    while (1) 
    {
        ...
        *male_total  = *male_total - 1;
        ...
        // если в ванную вошел первый мужчина и есть ожидающие женщины, устанавливаем флаг очереди для женщин. При освобождении ванной комнаты начнут заходить женщины
